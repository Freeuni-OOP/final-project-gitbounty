...
ALTER TABLE codebase_members
    ADD CONSTRAINT FK_CODEBASE_MEMBERS_ON_REPO FOREIGN KEY (repo_id) REFERENCES codebases (id);

ALTER TABLE codebase_members
    ADD CONSTRAINT FK_CODEBASE_MEMBERS_ON_USER FOREIGN KEY (user_id) REFERENCES users (id);